...
@Field private static final String MLD_DEPLOYED_VERSION = "0.3.8"
...
def mainPage() {
    ...
    dynamicPage(name: "mainPage", uninstall: true, install: true) {
        section("About Modern Dashboard", hideable: true, hidden: true) {
            ...
            paragraph "<small>Version 0.3.8 · Ephrayim (evdev) · Apache License 2.0 · <a href='https://github.com/evdev/hubitat-modern-dashboard' target='_blank'>Source</a></small>"
        }
        if (assetsOk) {
